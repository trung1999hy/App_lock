...
import com.example.applock.databinding.FragmentAppLockBinding
import com.example.applock.ui.main.MainFragment
import com.example.applock.view.patternlockview.widget.AppLockItemAnimator
                ...
                it.checkPermission() {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && Settings.canDrawOverlays(
                        ...
                        viewModel.removeAppLock(appLock.apply { isLock = false }) {
                            ...
                            LocalBroadcastManager.getInstance(activity as PermissionActivity<*>).sendBroadcast(intent)
                        }
                    } else Toast.makeText(
                        requireContext(),
